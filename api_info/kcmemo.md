...
なお、レアリティ値は8段階であり、 1藍＜2青＜3水＜4銀＜5金＜6虹＜7輝虹＜8桜虹 とする。

|艦船ID|艦名|設定レアリティ|グラフィック|差分|
|--:|:--|:--|:--|:--|
|143|武蔵|輝虹|桜虹|-1|
|148|武蔵改|輝虹|桜虹|-1|
|194|羽黒改二|金|虹|-1|
...
|348|瑞穂改|金|虹|-1|
|350|海風改|銀|金|-1|
|364|Warspite改|桜虹|輝虹|1|
|365|Aquila改|桜虹|輝虹|1|
|384|松輪改|銀|金|-1|
|392|Richelieu改|桜虹|輝虹|1|
|393|Ark Royal改|桜虹|輝虹|1|
|397|Intrepid改|桜虹|輝虹|1|
|450|秋津洲改|桜虹|輝虹|1|
|461|翔鶴改二|桜虹|輝虹|1|
|462|瑞鶴改二|桜虹|輝虹|1|
|465|鹿島|水|銀|-1|
...
|467|瑞鶴改二甲|桜虹|輝虹|1|
|490|荒潮改二|銀|輝虹|-3|
|496|Zara due|桜虹|輝虹|1|
|508|鈴谷航改二|桜虹|輝虹|1|
|509|熊野航改二|桜虹|輝虹|1|
|541|長門改二|桜虹|輝虹|1|
|545|Saratoga Mk.II|桜虹|輝虹|1|
|550|Saratoga Mk.II Mod.2|桜虹|輝虹|1|
|553|伊勢改二|桜虹|輝虹|1|
...
* 651: ネ式エンジンの増産
* 652: 「特注家具」の調達
* 653: 工廠稼働！次期作戦準備！ / 節分特別任務：節分準備！
* 654: 【丙】作戦「彩雲」調達＆輸送分解
* 655: 工廠フル稼働！新兵装を開発せよ！ / 「彩雲」輸送分解
* 657: 新型兵装開発整備の強化 / 春の準備任務：桃の節句準備！
* 658: 潜水艦武装の強化
* 666: 精鋭「瑞雲」隊の編成
* 668: 新型戦闘糧食の試作
* 966: 南西海域「基地航空隊」開設！
...
* 達成していたとしても `api_state` が 2 (遂行中) のままである。一部には `api_c_flag` というフラグが 1 になる必要がある。
...
二期には `main.js/DutyModel_.prototype._statusUpdate<任務ID>` に。
...
|568|16inch三連装砲|161|16inch三連装砲 Mk.7|
...
|589|深海5.5inch連装砲改|310|14cm連装砲改|
|590|深海標的|309|甲標的 丙型|
|591|深海5inch単装砲 Mk.30|284|5inch単装砲 Mk.30|
|592|深海16inch Mk.VIII連装砲改|332|16inch Mk.VIII連装砲改|
|593|高速深海魚雷 mod.3|314|533mm五連装魚雷(初期型)|
|596|深海6inch三連装新型速射砲|340|152mm/55 三連装速射砲|
|599|深海4.7inch砲 Mk.XII|280|QF 4.7inch砲 Mk.XII改|
|600|深海8inch連装速射砲|50|20.3cm(3号)連装砲|
|601|深海8inch三連装砲 Mk.9|356|8inch三連装砲 Mk.9|
|602|深海5inch連装両用砲(集中配備)|362|5inch連装両用砲(集中配備)|
|603|深海対空レーダーMark.III+FCS|278|SK レーダー|
...
if ( 龍田改 からの改装である )
    return 5;
else if ( ( 鈴谷改二 | 鈴谷航改二 | 熊野改二 | 熊野航改二 ) からの改装である )
    return 20;
else if ( ( Saratoga Mk.II | Saratoga Mk.II Mod.2 ) からの改装である )
    return 30;
else
...
なお、改造後もこれらによる改修値は維持される。そのため、対潜値のある 瑞鳳改二乙 で改修した対潜値を、 瑞鳳改二 に引き継ぐことが可能。
...
* 退避した時点で HP は減少する。直後の `ship_deck` の時点で HP が減少したデータが送信されてくる。  
    ダメージについては [1, 現在HP) のランダムであると推測している。記録は以下の通り。
...
|--:|:--|--:|:--|:--|:--|:-:|:--|
|15|61cm四連装(酸素)魚雷|(30)|陽炎型改二|雷装+2|雷装+12|△|2基まで (3基以上は補正なし)
|24|彗星|553|伊勢改二|火力+2|火力+2, 対潜+3, 爆装+8|○|
|57|彗星一二型甲|553|伊勢改二|火力+2|火力+2, 対潜+3, 索敵+1, 爆装+10|○|
|58|61cm五連装(酸素)魚雷|<4>, (22), (54)|重雷装巡洋艦, 島風型, 秋月型|雷装+1|雷装+13, 命中+1|○|
|61|二式艦上偵察機|553|伊勢改二|火力+3, 装甲+1, 回避+2, 射程+1|火力+3, 対空+1, 装甲+1, 回避+2, 索敵+7, 命中+3, 射程+1|×|射程が1レベル延長される
|67|53cm艦首(酸素)魚雷|!(<13>, <14>)|潜水艦・潜水空母以外|雷装-5|雷装+10|?|
|79|瑞雲(六三四空)|(2), (26)|伊勢型改, 扶桑型改二|火力+2|火力+2, 対空+2, 対潜+5, 索敵+6, 命中+1, 爆装+6|○|
|79|瑞雲(六三四空)|553|伊勢改二|火力+3|火力+3, 対空+2, 対潜+5, 索敵+6, 命中+1, 爆装+6|○|
|81|瑞雲12型(六三四空)|(2), (26)|伊勢型改, 扶桑型改二|火力+2|火力+2, 対空+3, 対潜+6, 索敵+7, 命中+1, 爆装+9|○?|
|81|瑞雲12型(六三四空)|553|伊勢改二|火力+3|火力+3, 対空+3, 対潜+6, 索敵+7, 命中+1, 爆装+9|○?|
|82|九七式艦攻(九三一空)|380, 529|大鷹改(二)|対潜+1, 回避+1|雷装+6, 対潜+8, 回避+1, 索敵+2|○|
|100|彗星(江草隊)|553|伊勢改二|火力+4|火力+4, 対空+1, 対潜+5, 索敵+4, 命中+4, 爆装+13|○?|
...
|111|彗星(六〇一空)|553|伊勢改二|火力+2|火力+2, 対潜+4, 索敵+1, 命中+1, 爆装+11|○|
|174|53cm連装魚雷|(66)|神風型|雷装+1, 回避+2|雷装+4, 回避+4|○|
|179|試製61cm六連装(酸素)魚雷|(54)|秋月型|雷装+1|雷装+15, 命中+2|○?|
|229|12.7cm単装高角砲(後期型) +10|(28), (66)|睦月型, 神風型|火力+1, 対空+1|火力+2, 対空+5, 対潜+1, 回避+1, 命中+1|○|
|-|(水上電探)|(28), (66)|睦月型, 神風型|火力+2, 回避+3|-|×|12.7cm単装高角砲(後期型) +10 装備時のみ
|229|12.7cm単装高角砲(後期型) +10|<1>|海防艦|火力+1, 対空+1|火力+2, 対空+5, 対潜+1, 回避+1, 命中+1|○|
|-|(水上電探)|<1>|海防艦|火力+1, 回避+4|-|×|12.7cm単装高角砲(後期型) +10 装備時のみ
|229|12.7cm単装高角砲(後期型) +10|488|由良改二|火力+2, 対空+3|火力+3, 対空+7, 対潜+1, 回避+1, 命中+1|○|
|-|(水上電探)|488|由良改二|火力+3, 回避+2|-|×|12.7cm単装高角砲(後期型) +10 装備時のみ
|237|瑞雲(六三四空/熟練)|(26)|扶桑型改二|火力+2|火力+2, 対空+4, 対潜+6, 回避+1, 索敵+7, 命中+1, 爆装+9|○?|
|237|瑞雲(六三四空/熟練)|(2)|伊勢型改|火力+3, 回避+1|火力+3, 対空+4, 対潜+6, 回避+2, 索敵+7, 命中+1, 爆装+9|○?|
|237|瑞雲(六三四空/熟練)|553|伊勢改二|火力+4, 回避+2|火力+4, 対空+4, 対潜+6, 回避+3, 索敵+7, 命中+1, 爆装+9|○?|
|266|12.7cm連装砲C型改二|(30)|陽炎型改二|火力+1|火力+4, 対空+2, 装甲+1, 命中+1|×|1基搭載時
|266|12.7cm連装砲C型改二|(30)|陽炎型改二|火力+2|火力+5, 対空+2, 装甲+1, 命中+1|×|2基搭載時 (3基以上は補正なし)
|267|12.7cm連装砲D型改二|543|長波改二|火力+3, 回避+1|火力+6, 対空+3, 装甲+1, 回避+2, 命中+2|○|
|267|12.7cm連装砲D型改二|(22), (38)|島風型, 夕雲型|火力+2, 回避+1|火力+5, 対空+3, 装甲+1, 回避+2, 命中+2|○|
|267|12.7cm連装砲D型改二|(30)|陽炎型|火力+1, 回避+1|火力+4, 対空+3, 装甲+1, 回避+2, 命中+2|○|
|267|12.7cm連装砲D型改二|(30)|陽炎型改二|火力+1|火力+5, 対空+3, 装甲+1, 回避+2, 命中+2|×|1基搭載時 (上のと合計で 火力+2, 回避+1), 2基目以降は上と同じ補正
|-|(水上電探)|229, 543|島風改, 長波改二|火力+1, 雷装+3, 回避+2|-|×|12.7cm連装砲D型改二 装備時のみ|
|268|北方迷彩(+北方装備)|216, 547, 217, 146|多摩改(二), 木曾改(二)|装甲+2, 回避+7|装甲+4, 回避+9|×|
|285|61cm三連装(酸素)魚雷後期型|(1), (5), (10), (12)|綾波型改二, 暁型改二, 初春型改二, 吹雪型改二|雷装+2, 回避+1|雷装+11, 装甲+1, 回避+3, 命中+2|?|
|285|61cm三連装(酸素)魚雷後期型 +10|(1), (5), (10), (12)|綾波型改二, 暁型改二, 初春型改二, 吹雪型改二|火力+1|火力+1, 雷装+11, 装甲+1, 回避+3, 命中+2|?|上記補正に追加される
|286|61cm四連装(酸素)魚雷後期型|(18), (23), (30), (38)|朝潮型改二, 白露型改二, 陽炎型改二, 夕雲型改二|雷装+2, 回避+1|雷装+13, 装甲+1, 回避+1, 命中+2|?|
|286|61cm四連装(酸素)魚雷後期型 +5|(30)|陽炎型改二|雷装+1|雷装+14, 装甲+1, 回避+1, 命中+2|?|上記補正に追加される
|286|61cm四連装(酸素)魚雷後期型 +10|(18), (23), (30), (38)|朝潮型改二, 白露型改二, 陽炎型改二, 夕雲型改二|火力+1|火力+1, 雷装+13 (or14), 装甲+1, 回避+1, 命中+2|?|上記補正に追加される
|289|35.6cm三連装砲改(ダズル迷彩仕様)|149|金剛改二|火力+2, 対空+1|火力+21, 対空+6, 回避+2, 命中+3|○|
|289|35.6cm三連装砲改(ダズル迷彩仕様)|150, 152|比叡改二, 霧島改二|火力+1|火力+20, 対空+5, 回避+2, 命中+3|○|
|289|35.6cm三連装砲改(ダズル迷彩仕様)|151|榛名改二|火力+2, 対空+2, 回避+2|火力+21, 対空+7, 回避+4, 命中+3|○|
|-|(水上電探)|149, 151|金剛改二, 榛名改二|火力+2, 回避+2|-|×|35.6cm三連装砲改(ダズル迷彩仕様) 装備時のみ|
|290|41cm三連装砲改二|(26)|扶桑型改二|火力+1|火力+24, 対空+6, 命中+5|?|
|290|41cm三連装砲改二|(2)|伊勢型改(二)|火力+2, 対空+2, 回避+1|火力+25, 対空+8, 回避+1, 命中+5|?|
|-|(対空電探)|(2)|伊勢型改(二)|対空+2, 回避+3|-|×|41cm三連装砲改二 装備時のみ|
|291|彗星二二型(六三四空)|553|伊勢改二|火力+6, 回避+1|火力+6, 対空+1, 対潜+4, 回避+1, 命中+2, 爆装+11|○?|
|292|彗星二二型(六三四空/熟練)|553|伊勢改二|火力+8, 対空+1, 回避+2|火力+8, 対空+3, 対潜+5, 回避+2, 索敵+2, 命中+3, 爆装+12|○?|
|293|12cm単装砲改二|<28>, <66>|睦月型, 神風型|火力+2, 対空+1, 回避+3?|火力+3, 対空+1, 装甲+1, 回避+4, 命中+1?|○?|
|293|12cm単装砲改二|<74>, <77>|占守型, 択捉型|火力+1, 対空+1, 回避+2?|火力+3, 対空+1, 装甲+1, 回避+3, 命中+1?|○?|
|295|12.7cm連装砲A型改三(戦時改修)+高射装置|<12>|吹雪型|火力+2, 対空+2|火力+4, 対空+10, 装甲+1, 命中+1|○?|
|297|12.7cm連装砲A型|<12>|吹雪型|回避+2|火力+2, 対空+1, 回避+2|○|

備考：

* 「水上電探」は 命中≧3 の電探、「対空電探」は 対空≧2 の電探を指す。
* 「改二」には「丁改」は含まない模様。
* 伊勢改二+二式艦偵 の 射程+1 効果は、超長より伸ばすことが可能らしい([実験](https://twitter.com/andanteyk/status/1007890451037163520))。  
...
* 478 龍田改二 : 53cm連装魚雷 +3
* 498 村雨改二 : 25mm三連装機銃 +3
* 567 不知火改二 : 12.7cm連装砲C型改二 +5, 25mm三連装機銃 +5
* 568 黒潮改二 : 12.7cm連装砲C型改二 +5, 三式爆雷投射機 +5


#### 対空噴進弾幕について

対空噴進弾幕のクライアント側における表示処理についてまとめる。
...
要するに、対空噴進弾幕表示は「装備・艦種条件を満たしたうえで、航空戦での被ダメージが 0 のとき」に必ず表示される…はずである。  
当該艦がターゲットされていなくても表示される。  


#### 臨時補給について
通常の補給とは異なり、遠征画面での補給は艦載機の補充を行わない。


#### 連合艦隊夜戦における僚艦夜戦突撃のバグ
2020/06/30 ごろ、[連合第二艦隊で僚艦夜戦突撃を発動した際、演出で第一艦隊の艦が表示される不具合](https://twitter.com/KanColle_STAFF/status/1277795234848489472)が報告されていた。  
これはすぐに修正されたものの、2020/08/08 現在、API 上では依然として第一艦隊の艦が攻撃していることになっている。  
(攻撃艦のインデックスが、本来 6 である部分が 0 になっている)  
ソース: [1](https://pastebin.com/eBBC3GyB) [2](https://pastebin.com/R93qLUCD) 
