...
MaintenanceInfo.StartDateTime = Date.parse("2020/02/07 11:00:00");
MaintenanceInfo.EndDateTime   = Date.parse("2020/02/07 20:50:00");

// Version 情報
var VersionInfo = {};
VersionInfo.scriptVesion      = "4.5.4.0";
