...
MaintenanceInfo.StartDateTime = Date.parse("2020/03/03 11:00:00");
MaintenanceInfo.EndDateTime   = Date.parse("2020/03/03 19:40:00");

// Version 情報
var VersionInfo = {};
VersionInfo.scriptVesion      = "4.5.5.3";
