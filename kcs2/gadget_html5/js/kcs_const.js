...
MaintenanceInfo.StartDateTime = Date.parse("2020/04/23 11:00:00");
MaintenanceInfo.EndDateTime   = Date.parse("2020/04/23 18:30:00");

// Version 情報
var VersionInfo = {};
VersionInfo.scriptVesion      = "4.5.7.2";
