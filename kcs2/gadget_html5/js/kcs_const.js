...
MaintenanceInfo.StartDateTime = Date.parse("2020/01/14 11:00:00");
MaintenanceInfo.EndDateTime   = Date.parse("2020/01/14 20:00:00");

// Version 情報
var VersionInfo = {};
VersionInfo.scriptVesion      = "4.5.3.1";
