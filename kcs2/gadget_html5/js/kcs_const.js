...
MaintenanceInfo.StartDateTime = Date.parse("2023/01/20 00:00:00");
MaintenanceInfo.EndDateTime   = Date.parse("2023/01/20 00:59:59");

// Version 情報
var VersionInfo = {};
VersionInfo.scriptVesion      = "5.5.7.2";
